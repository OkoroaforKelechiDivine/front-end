        ...
        <footer className={'footer'}>
            ...
            <div className={"socials"}>
                <a href={"#"} className={"socialIcon"}>
                    <SocialIcon url={"https://web.facebook.com/profile.php?id=100080210275192"} target={"_blank"}/>
                </a>

                <a href={"#"} className={"socialIcon"}>
                <SocialIcon url={"https://twitter.com/kelechiDivine6"} target={"_blank"}/>
                </a>

                <a href={"#"} className={"socialIcon"}>
                    <SocialIcon url={"https://www.linkedin.com/in/kelechi-okoroafor/"} target={"_blank"}/>
                </a>

                <a href={"#"} className={"socialIcon"}>
                    <SocialIcon url={"https://medium.com/@okoroaforkelechi123"} target={"_blank"}/>
                </a>
                </div>
        </footer>
    )
